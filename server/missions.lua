...
RegisterNetEvent('rodz-piloto:server:completeSpecialMission', function()
    ...
    -- Calcular recompensa (R$ 500 a R$ 1.500)
    local reward = math.random(Config.SpecialMissionReward.min, Config.SpecialMissionReward.max)
    ...
    -- Notificar cliente
    TriggerClientEvent('rodz-piloto:client:specialMissionCompleted', src, reward)
    
    -- Log
    print(string.format("^2[RODZ-PILOTO]^7 Player %s completed special mission | R$ %s", src, reward))
end)
