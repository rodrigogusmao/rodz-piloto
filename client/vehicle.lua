...
-- =======================================================================================
function SpawnWorkPlane(model)
    -- Usar o modelo escolhido pelo jogador; fallback para a lista padrão
    local planeModel = model or Config.AvailablePlanes[math.random(#Config.AvailablePlanes)]

    print("^3[RODZ-PILOTO]^7 Spawning plane:", planeModel)

    -- Solicitar modelo
    lib.requestModel(planeModel, 10000)
