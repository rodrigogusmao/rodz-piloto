...
-- Menu antigo (ox_lib) substituído pela NUI tablet — ver client/nui.lua.
-- As funções OpenInstructorMenu/OpenCancelConfirmMenu permanecem apenas como
-- referência e não são mais chamadas (o target do NPC abre o tablet).
